...
if (length(args) == 4) {
  cat("Rscript run_sims.R to begin:")
  cat("Mandatory Arguments:",
      ...
      "--sample 100/3000", 
      "--adjust TRUE/FALSE", 
      "--schedule disjoint/dynamic",
      "--result TRUE/FALSE",
      sep="\n")
  cat("If --action file is provided, need to provide mandatory arguments:",
      "--file default/<file_path>",
      "If --action file is provided, here are some optional arguments:",
      "--cpu_use <0-1> default 0.85",
      "--total_trace <trace_length> default 8000",
      "If --sim offline is provided, here are some optional arguments:",
      "--max_run_length <max_run_length> default: 37",
      "--initial_train_size <initial_training_length> default: 6000",
      "If --model Markov/AR1_Markov/AR1_state_based_logistic is provided, need to provide mandatory arguments:",
      "--state <state_num>",
      "If --model AR1_logistic_lm/AR1_logistic_glm is provided, need to provide mandatory arguments:",
      "--bin <bin_num>",
      sep="\n")
  cat("If --action param is provided, need to provide mandatory arguments:",
      "--window <window_size>",
      "--prob <cut_off_probability>",
      "--gran <granularity>",
      "If --action param is provided, here are some optional arguments:",
      "--cpu_use <0-1> default 0.85",
      "--total_trace <trace_length> default 8000",
      "If --sim offline is provided, here are some optional arguments:",
      "--max_run_length <max_run_length> default: 37",
      "--initial_train_size <initial_training_length> default: 6000",
      "If --sim online is provided, need to provide mandatory arguments:",
      "--train <train_size>",
      "--update <update_freq>",
      "If --model Markov/AR1_Markov/AR1_state_based_logistic is provided, need to provide mandatory arguments:",
      "--state <state_num>",
  ...
  if (action == "file") {
    ...
    if (simulation == "online") {
      ...
      max_run_length <- arg_checker("--max_run_length", args, FALSE, 37)
