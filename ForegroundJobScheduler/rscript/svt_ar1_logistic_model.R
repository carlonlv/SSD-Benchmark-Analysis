...
wrapper.epoche <- function(parameter, dataset_avg, dataset_max, cpu_required, initial_train_size, update_freq, cond.var, bad.seq.adj, output_dp) {
  ...
  if (cond.var == "lm") {
    ...
    write.csv(output$pi_up, file = paste("AR1_logistic_lm",job_length, sample_size, prob_cut_off, granularity, "avg_usage.csv"))
    write.csv(output$scheduling_summary, file = paste("AR1_logistic_lm", job_length, sample_size, prob_cut_off, granularity, "job_survival.csv"))
    ...
    write.csv(output$pi_up, file = paste("AR1_logistic_kmeans",job_length, sample_size, prob_cut_off, granularity, "avg_usage.csv"))
    write.csv(output$scheduling_summary, file = paste("AR1_logistic_kmeans", job_length, sample_size, prob_cut_off, granularity, "job_survival.csv"))
