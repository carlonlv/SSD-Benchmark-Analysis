...
draw_plots <- function(file_name) {
  ...
  plot(virtual_page_num, frequencies, main = paste("Scatter plot of" , file_name))
  print("Done plotting")
  dev.off()
  ...
  smoothScatter(virtual_page_num, frequencies, main = paste("Density Scatter Plot of" , file_name))
  dev.off()
